...
docker tag threemammals-com $THREEMAMMALS_ACR_URL/$DOCKER_LATEST_TAG
docker tag threemammals-com $THREEMAMMALS_ACR_URL/$DOCKER_TAG

docker push $THREEMAMMALS_ACR_URL/$DOCKER_TAG
docker push $THREEMAMMALS_ACR_URL/$DOCKER_LATEST_TAG